...
public class EmpleadoController {
    ...
    @Description(value = "Registrar", permission = "ROLE_EMPLEADO_SAVE", description = "Permite registrar un empleado en la base de datos. El permiso Visualizar Pantalla debe estar habilitado")
